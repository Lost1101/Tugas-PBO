        ...
        <div class="bg p-4 mb-5 mt-5 text text-center text-black" style="width:75%; margin: auto;">
            <div class="container">
				<script>function display_ct7() {
					...
					<span id='ct7' class="text-white d-block"></span>
				<img src="img/logo.png" alt="" style="width: 200px; height:200px;">
                <p class="headerp text-light">Please login first</p>
                    <div class="datainput">
                        <form action="ceklogin.php" method="post" autocomplete="off" class="m-3">
                            <div class="input-group mb-3">
                              ...
                              <button class="btn btn-outline-light mt-3" type="submit" name="login"><i class="fa-solid fa-right-to-bracket"></i> Login</button>
                        </form>
                    </div>
            </div>
        </div>
