...
<body>
    <div>
        <div class="bg p-4 mb-5 text text-left bg-success" style="width: 100%; top: 0;">
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <div class="text-center mx-auto p-3">
					...
					<p id='ct7' class="text-white d-block"></p>

                    <a class="mt-3" href="antrian.php" style="text-decoration: none;">
                        <button class="btn btn-primary   text-center" style="height: 40px;">Antrian</button>
                    </a>
                </div>
        ...
        <div class="h4 pb-2 mb-4 text-success border-bottom border-success w-75 mx-auto">
            <h3>Pesanan</h3>
        </div>
